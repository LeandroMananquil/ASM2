...
// async function findProductsByName(req, res) {
//   try {
//     // Extract the keyword from the request query
//     const keyword = req.query.name;

//     // Check if the keyword is provided
//     if (!keyword) {
//       return res.status(400).json({ message: "Keyword is required for searching products by name." });
//     }

//     // Use a case-insensitive regular expression to search for products
